...
params.java_env = "/tscc/projects/ps-lalexandrov/shared/EVC_nextflow/yml/java.yml"
params.muse_env = "/tscc/projects/ps-lalexandrov/shared/EVC_nextflow/yml/muse2.yml"
params.fastqc_env = "/tscc/projects/ps-lalexandrov/shared/EVC_nextflow/yml/fastqc_env.yml"
...
include { GETpileUP_exome } from './Modules/Mutect2/GETpileUP_exome.nf' 
...
workflow {
   ...
   //COMBINE_REPORTS_RECAL(CHECK_BAM_RECAL_out.individual_reports_recal.collect())
    ...
    //10
    if (params.type == "exome") {
            GETpileUP_exome(RECALIBRATE_out.GETpileUP_input).set { GETpileUP_out }
            ...
            GETpileUP_out.CalculateContamination_input.filter{it[1]== 'normal'}.set{ GETpileUP_normal }
            GETpileUP_out.CalculateContamination_input.filter{it[1]== 'tumor'}.set{ GETpileUP_tumor }
