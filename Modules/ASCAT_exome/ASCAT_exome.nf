...
process ASCAT_exome {
    ...
    ascat.bc = ascat.loadData(Tumor_LogR_file = "${tumor_logr}", Tumor_BAF_file = "${tumor_baf}", Germline_LogR_file = "${normal_logr}", Germline_BAF_file = "${normal_baf}", gender = "${gender}", genomeVersion = "${params.ascat_ref_genome_version_wes}")
